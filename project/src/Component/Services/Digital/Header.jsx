...
export default function Header({ title, subtitle }) {
  ...
  const pageTitle = title || "Digital Strategy";
  const pageSubtitle = subtitle || "Data-driven digital strategies designed to maximize your brand's growth, engagement, and ROI.";
