...
export default function Header({ title, subtitle }) {
  ...
  const pageTitle = title || "Creative Strategy";
  const pageSubtitle = subtitle || "Innovative and compelling creative solutions that captivate audiences and elevate your brand.";
  ...
  useEffect(() => {
    if (currentTitleIndex < pageTitle.length) {
      ...
      }, isMobile ? 60 : 80); // Faster typing on mobile
  ...
  useEffect(() => {
    if (isSubtitleTyping && currentSubtitleIndex < pageSubtitle.length) {
      ...
      }, isMobile ? 20 : 30); // Much faster typing on mobile
